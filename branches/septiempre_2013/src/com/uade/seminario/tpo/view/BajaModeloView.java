	...
	private void initGUI() {
		try {
			...
			}
			{
				...
				confirmar.setText("Dar de baja");
				confirmar.setBounds(143, 289, 131, 23);
				confirmar.addActionListener(new ActionListener() {
					
					public void actionPerformed(ActionEvent arg0) {
						if(!codigo.getText().equals("")){
							try {
								SistemadeReparaciones.getInstancia().bajaModelo(Integer.parseInt(codigo.getText()));
								dispose();
							} catch (NumberFormatException e) {
								// TODO Auto-generated catch block
								e.printStackTrace();
							} catch (ExceptionModeloInactivo e) {
								// TODO Auto-generated catch block
								e.printStackTrace();
							}
